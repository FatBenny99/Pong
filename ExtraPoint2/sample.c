...
//variabili globali del paddle2
volatile int toprightx2,toprighty2;
volatile int bottomleftx2,bottomlefty2;
...
int main(void)
{
  ...
  points=0;
	...
	LCD_Paddle(64,10,90,32,2);        //inizializzazione paddle 2
