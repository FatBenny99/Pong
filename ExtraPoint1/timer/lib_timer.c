...
//*** <<< end of configuration section >>>    ***
  ...
  else if ( timer_num == 1 )
  {
	...
	NVIC_SetPriority(TIMER1_IRQn,0);     /*priorità massima ai bottoni*/
	...
	else if ( timer_num == 2 )
  {
	...
	NVIC_SetPriority(TIMER2_IRQn, 1);	/*meno priorità dei bottoni ma più della palla*/
	return (1);
  }
	else if ( timer_num == 3 )
  {
	...
	NVIC_SetPriority(TIMER3_IRQn, 1);	/* stessa priorità degli altri rimbalzi*/
	return (1);
  }
